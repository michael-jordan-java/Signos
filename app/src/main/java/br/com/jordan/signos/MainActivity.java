...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvSignos.setOnItemClickListener(listenerItens);
    }

    private ListView.OnItemClickListener listenerItens = new AdapterView.OnItemClickListener() {
        @Override
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            String signo = parent.getItemAtPosition(position).toString();
            showMessage(signo + ": " + perfil[position]);
        }
    };
